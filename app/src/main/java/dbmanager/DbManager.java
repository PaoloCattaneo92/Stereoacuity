...
/**
 * Created by Eleonora on 01/02/2016.
 * asd
 */
public class DbManager
{
    ...
    //stsv = session to string verbose
    public void save(String stsv, String username, String date)
    {
        SQLiteDatabase db=dbhelper.getWritableDatabase();

        ContentValues cv=new ContentValues();
        cv.put(DatabaseStrings.FIELD_SESSIONTOTSRINGV, stsv);
        cv.put(DatabaseStrings.FIELD_USERNAME, username);
